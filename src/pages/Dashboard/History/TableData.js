...
import { Table, Tbody, Tr, Icon } from "@chakra-ui/react";
          ...
          return (
            <Tr key={item.title + i}>
              <CustomTd pl="0">
                <Icon
                  as={
                    item.isArrowPositive ? AiOutlineArrowDown : AiOutlineArrowUp
                  }
                  color={item.isArrowPositive ? "positive.500" : "negative.500"}
                  boxSize="23px"
                  background={
